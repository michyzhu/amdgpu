...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='main_moco_checkpoint_v2/checkpoint_{:04d}.pth.tar'.format(epoch))
...
def save_checkpoint(state, is_best, filename='main_moco_checkpoint_v2/checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'main_moco_checkpoint_v2/model_best.pth.tar')
